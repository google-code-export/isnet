...
ALTER TABLE MEMBER
MODIFY(MEMBER_FIRST_NAME VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_LAST_NAME VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_STREET_ADDRESS VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_CITY VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_EMAIL VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_COMPANY_NAME VARCHAR2(255 BYTE));

ALTER TABLE MEMBER
MODIFY(MEMBER_PASSWORD VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_INTRODUCTION_URL VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_LINKED_IN_LINK_URL VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_WILLING_TO_HOST_INDICAT VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_CAN_ANSWER_QUESTIONS_IN VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_HIGHEST_EDUCATION_DEGRE VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_HIGHEST_EDUCATION_INSTI VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_QUALIFIED_FIQH_INDICATO VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_HIGHEST_EDUCATION_SUBJE VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_SECURITY_ANSWER_1 VARCHAR2(255 BYTE));


ALTER TABLE MEMBER
MODIFY(MEMBER_SECURITY_ANSWER_2 VARCHAR2(255 BYTE));
