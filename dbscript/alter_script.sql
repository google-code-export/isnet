...
ALTER TABLE PAYPAL_IPN_LOG ADD (VERIFY_STATUS  CHAR(1));

ALTER TABLE TUTORIAL_TEST_DETAILS ADD CONSTRAINT TEST_QUESTION_UK1 UNIQUE (TUTORIAL_TEST_ID, QUESTION_ID) ENABLE VALIDATE;

-- New Alter script
ALTER TABLE TEST_TUTORIAL_DOCUMENT MODIFY(DOCUMENT_NAME VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_MODULES MODIFY(MODULE_NAME VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION_OPTION_ANSWER_A VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION_OPTION_ANSWER_B VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION_OPTION_ANSWER_C VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION_OPTION_ANSWER_D VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION_OPTION_ANSWER_E VARCHAR2(500 BYTE));
ALTER TABLE TEST_TUTORIAL_QUESTION_ANS MODIFY(QUESTION_OPTION_ANSWER_F VARCHAR2(500 BYTE));

-- End of new alter script

-- alter table TUTORIAL_TEST_DETAILS
ALTER TABLE TUTORIAL_TEST MODIFY(TUTORIAL_TEST  NULL);

-- alter table TUTORIAL_TEST_DETAILS
ALTER TABLE TUTORIAL_TEST_DETAILS MODIFY(MENTOR_ANSWER  NULL);
...
-- alter table PROTEGE_EVALUATION_OF_MENTOR
ALTER TABLE PROTEGE_EVALUATION_OF_MENTOR ADD CONSTRAINT PROTEGE_EVAL_OF_MENTOR_PK PRIMARY KEY (PROTEGE_EVAL_OF_MENTOR_ID) ENABLE VALIDATE;
