...
public interface MessageDao extends GenericDao<Message,Long>{
	...
	/** Get the list of all conversation belongs to the member based on read or unread status */
	public List<Message> getUnReadConversationByOwnerId(Long ownerId, String status, String readStatus,int startIndex, int pageSize);	
