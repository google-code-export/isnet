...
public class ModulesViewHandler extends BasePage implements Serializable {
  ...
  protected static final Logger logger = Logger.getLogger( ModulesViewHandler.class );
  ...
  public void loadDocuments() {
    ...
    try {
      ...
      if(recordList!=null && !recordList.isEmpty()) {
        ...
        while(iterator.hasNext()) {
          ...
          if ( object != null ) {
            vList.add(new SelectItem(""+object.getDocumentId(),""+object.getDocumentName()));
          }
        }      
      } 
    ...
    try {
      ...
      List<TestTutorialModules> recordList = modulesService.findByProperties(docTypeId, userId);
	...
	public void preAddModules () {	  
	  ...
	  try {			
	    if (preValidate()) {
  	    ...
  	    setSecHeaderMsg(this.getText("header_msg_tutorial_modules") + " " + this.getText("header_msg_add"));
	  ...
	  try {		  
		  ...
		  if(postValidate(this.currentModules)) {  			
		    this.modulesService.addModules(this.currentModules);
  			List<TestTutorialModules> itemList = (List<TestTutorialModules>) getModulesLines().getWrappedData();
	...
	public void preUpdateModules() {
	  ...
	  if(this.getParameter(ServiceConstants.RECORD_ID)!=null) {
  		...
  		try {  		 
  		  ...
  		  setSecHeaderMsg(this.getText("header_msg_tutorial_modules") + " " + this.getText("header_msg_update"));
	...
	private void putObjInList(int idx,Object fetchObj) {
		try {
		  List<TestTutorialModules> list = (List<TestTutorialModules>) getModulesLines().getWrappedData();
		  list.remove(idx);
	...
	/**
	 * @param currentModules the currentModules to set
	 */
  ...
  public void setUserType(String userType) {
	...
	/**
	 * @param modulesLines the modulesLines to set
	 */
