...
public class TestTutorialQuestionAns implements Serializable {
	...
	public TestTutorialQuestionAns(long questionAnsId, Long pageNumber,
			String pageText) {
	...
	/**
	 * @param questionCorrectAnswer
	 *            the questionCorrectAnswer to set
	 */
	...
	/**
	 * @param questionOptionAnswerA
	 *            the questionOptionAnswerA to set
	 */
	...
	/**
	 * @param questionOptionAnswerB
	 *            the questionOptionAnswerB to set
	 */
	...
	/**
	 * @param questionOptionAnswerC
	 *            the questionOptionAnswerC to set
	 */
	...
	/**
	 * @param questionOptionAnswerD
	 *            the questionOptionAnswerD to set
	 */
	...
	/**
	 * @param questionOptionAnswerE
	 *            the questionOptionAnswerE to set
	 */
	...
	/**
	 * @param questionOptionAnswerF
	 *            the questionOptionAnswerF to set
	 */
