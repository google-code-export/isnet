...
(
  ...
  QUESTION_OPTION_ANSWER_A       VARCHAR2(100 BYTE),
  QUESTION_OPTION_ANSWER_B       VARCHAR2(100 BYTE),
  QUESTION_OPTION_ANSWER_C       VARCHAR2(100 BYTE),
  QUESTION_OPTION_ANSWER_D       VARCHAR2(100 BYTE),
  QUESTION_OPTION_ANSWER_E       VARCHAR2(100 BYTE),
  QUESTION_OPTION_ANSWER_F       VARCHAR2(100 BYTE),
...
ALTER TABLE TUTORIAL_TEST ADD CONSTRAINT TUTORIAL_TEST_PK PRIMARY KEY (TUTORIAL_TEST_ID) ENABLE VALIDATE;
...
ALTER TABLE TUTORIAL_TEST_DETAILS ADD CONSTRAINT TUTORIAL_TEST_DETAILS_PK PRIMARY KEY (ID) ENABLE VALIDATE;
ALTER TABLE TUTORIAL_TEST_DETAILS ADD CONSTRAINT TUTORIAL_TEST_TEST_DETAILS_FK1 FOREIGN KEY (TUTORIAL_TEST_ID) REFERENCES TUTORIAL_TEST (TUTORIAL_TEST_ID) ENABLE VALIDATE;
--Alter for pk
...
DROP SEQUENCE TUTORIAL_TEST_ID_SEQ;
CREATE SEQUENCE TUTORIAL_TEST_ID_SEQ INCREMENT BY 1 START WITH 100 NOCYCLE NOCACHE NOORDER;

DROP SEQUENCE TUTORIAL_TEST_DETAILS_ID_SEQ;
CREATE SEQUENCE TUTORIAL_TEST_DETAILS_ID_SEQ INCREMENT BY 1 START WITH 100 NOCYCLE NOCACHE NOORDER;
