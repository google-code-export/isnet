...
public class ProtegeEvaluationOfMentor implements java.io.Serializable {
  ...
  /** Member Id */
	...
	@GeneratedValue(generator = "ProtegeEvalOfMentorSeq")
	@SequenceGenerator(name = "ProtegeEvalOfMentorSeq", sequenceName = "PROTEGE_EVAL_OF_MENTOR_ID_SEQ", allocationSize = 1, initialValue = 1)
  ...
  /**
   * @param protegeEvalOfMentorId the protegeEvalOfMentorId to set
   */
  ...
  /**
   * @param mentorMemberId the mentorMemberId to set
   */
  ...
  /**
   * @param protegeMemberId the protegeMemberId to set
   */
  ...
  /**
   * @param evalFactorOneText the evalFactorOneText to set
   */
  ...
  /**
   * @param evalFactorTwoText the evalFactorTwoText to set
   */
  ...
  /**
   * @param evalFactorThreeText the evalFactorThreeText to set
   */
  ...
  /**
   * @param evalFactorFourText the evalFactorFourText to set
   */
  ...
  /**
   * @param evalFactorFiveText the evalFactorFiveText to set
   */
  ...
  /**
   * @param evalFactorSixText the evalFactorSixText to set
   */
  ...
  /**
   * @param evalFactorOneRatingNum the evalFactorOneRatingNum to set
   */
  ...
  /**
   * @param evalFactorTwoRatingNum the evalFactorTwoRatingNum to set
   */
  ...
  /**
   * @param evalFactorThreeRatingNum the evalFactorThreeRatingNum to set
   */
  ...
  /**
   * @param evalFactorFourRatingNum the evalFactorFourRatingNum to set
   */
  ...
  /**
   * @param evalFactorFiveRatingNum the evalFactorFiveRatingNum to set
   */
  ...
  /**
   * @param evalFactorTotalRatingNum the evalFactorTotalRatingNum to set
   */
